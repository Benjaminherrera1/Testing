        ...
        if form.is_valid():
            ...
            if not usuario_existente:
                ...
                usuario_base_obj = usuario_base.objects.create(
                    nombre=username,
                    correo=email,
                    contraseña=email,  # Usamos el email como contraseña en usuario_base
                    rol="usuario_externo",
                    es_activo=True,
...
def pagina_usuario(request):
    if request.user.is_superuser:
        return redirect('/administracion/')  # o a la página de admin que uses
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            for usuario in usuarios:
                usuario.contraseña = request.user.email  # Mantenemos el email como contraseña en usuario_base
                usuario.save()
