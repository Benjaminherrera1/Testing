...
from administracion.models import Empresa, usuario_base  # CORRECTO: usamos usuario_base, no contactoEmpresa

class PostulacionIniciativa(models.Model):
    id = models.AutoField(primary_key=True)

    empresa = models.ForeignKey(Empresa, on_delete=models.CASCADE)
    contacto = models.ForeignKey(usuario_base, on_delete=models.CASCADE)  # ← CORREGIDO
